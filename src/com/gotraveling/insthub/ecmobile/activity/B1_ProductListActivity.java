...
import com.gotraveling.insthub.ecmobile.adapter.B1_ProductListAdapter;
import com.gotraveling.insthub.ecmobile.adapter.GoodListLargeListActivityAdapter;
import com.gotraveling.insthub.ecmobile.model.GoodsListModel;
...
import com.gotraveling.insthub.ecmobile.protocol.PAGINATED;
       ...
       final LinearLayout mainView = (LinearLayout) findViewById(R.id.keyboardLayout1);
        ...
        if (null != filter_string)
        {
            try
            {
                ...
                filter =new com.gotraveling.insthub.ecmobile.protocol.FILTER();
            ...
            case 1:
            {
                if(null != data)
                {
                    ...
                    if (null != filter_string)
                    {
                        ...
                        {
                            JSONObject filterJSONObject = new JSONObject(filter_string);
                            FILTER filter = new com.gotraveling.insthub.ecmobile.protocol.FILTER();
                            filter.fromJson(filterJSONObject);
