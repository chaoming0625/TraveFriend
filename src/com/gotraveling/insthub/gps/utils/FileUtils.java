...
public class FileUtils {
    ...
    @SuppressLint("NewApi")
	public static String SearchRealSD(){
        ...
        for (int i=0;i<files.length;i++) {
            File f = files[i];
            if (f.isDirectory() && f.canWrite()//sd��һ���ǿ�д��.���ȥ���������Ļ���õ����ص�ϵͳר���ļ���
                    && Math.abs(extFile.getTotalSpace() - f.getTotalSpace()) > 2 * 1024 * 1024) {
                //�ⲿ�洢������Ŀ¼����δ���ص����������ͬ�Ĵ洢����.��Ŀ¼�ǹ��صĻ�.�ͻ���ֲ�ͬ�Ĵ洢����
                //2 * 1024 * 1024 ������ָ�����洢���Ĵ洢������С���� ��Ȼ���Բ�����ô�� ����
                return f.getPath();
            }
        }
        ...
        for(int i=0;i<files.length;i++){
            ...
            if( f.isDirectory() && f.canWrite() ) {
                ...
                tmp = tmp.toUpperCase();
                if( tmp.indexOf("SDCARD1")>0 ) return  files[i].getPath();
                if (tmp.indexOf("EXT_SDCARD") > 0) return  files[i].getPath();
                if( tmp.indexOf("EXTERNAL_SD")>0 ) return  files[i].getPath();
            }
        }
    ...
    public static String getSDCardPath() {
        ...
        String tmp = SearchRealSD();
        if( tmp ==null|| tmp.length()<1 )      return Environment.getExternalStorageDirectory().getPath();
        return tmp;
    }
	...
	public static long getAvailableSize(String path) {
        try {
            ...
            long nAvailableCount =base.getFreeSpace();
    ...
    public static StringBuilder readFile(InputStream in, String charsetName ){
